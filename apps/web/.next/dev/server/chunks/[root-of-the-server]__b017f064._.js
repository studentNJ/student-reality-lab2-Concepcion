                    ...
                    steps: [
                        {
                            ...
                            execute: async (state)=>{
                                const comparison = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("compare_affordability_scenarios", {
                                    annualIncome: plan.annualIncome,
                                    targetMetro: plan.targetMetro ?? undefined,
                ...
                const steps = [
                    {
                        ...
                        execute: async (state)=>{
                            const range = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_metrics_by_range", {
                                startYear,
                                endYear
                            });
                ...
                if (plan.wantsChart) {
                    steps.push({
                        ...
                        execute: async (state)=>{
                            ...
                            const graph = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("create_graph", buildRangeGraphRequest(metric, startYear, endYear, range.result.data.rows));
                    ...
                    steps: [
                        {
                            id: "compare-metros",
                            execute: async (state)=>{
                                const comparison = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("compare_metros", {
                                    metros: plan.metros,
                                    startYear,
                                    endYear,
                                    metric: "rent_burden_percent"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b017f064._.js.map