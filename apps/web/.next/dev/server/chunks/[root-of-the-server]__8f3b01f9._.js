...
function calculateAffordabilityTool(input) {
    try {
        ...
        const targetMetroRent = validated.targetMetro ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$domain$2f$src$2f$trends$2f$get$2d$latest$2d$rent$2d$by$2d$metro$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLatestRentByMetro"])(validated.targetMetro) : null;
        ...
        const summary = affordability ? `${validated.targetMetro} is ${affordability.risk.toLowerCase()} at ${affordability.rentBurdenPercent}% of monthly income.` : `At 30% of monthly income, the maximum affordable monthly housing cost is $${maxAffordableMonthlyHousing}.`;
...
function getMetroTrendTool(input) {
    try {
        ...
        const trend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$domain$2f$src$2f$trends$2f$get$2d$metro$2d$trend$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMetroTrend"])(validated.metro, validated.startYear, validated.endYear);
...
function runTool(toolName, input = {}) {
    const result = toolRegistry[toolName](input);
    if (result.ok) {
        return {
            ok: true,
            toolName,
...
async function executePlan(plan, context) {
    switch(plan.intent){
        case "data_source_status":
            {
                const status = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_data_source_status");
        ...
        case "affordability":
            {
                ...
                const affordability = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("calculate_affordability", {
        ...
        case "metrics_snapshot":
            {
                ...
                const snapshot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_metrics_snapshot", {
                    year
                });
                if (!snapshot.ok) {
                    return createAssistantMessage({
                ...
                let chartSpec;
                if (plan.wantsChart) {
                    const graph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("create_graph", {
                        inputMode: "helper",
        ...
        case "metro_trend_chart":
            {
                ...
                const trend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_metro_trend", {
                    metro,
                    startYear,
                    endYear
                });
...
async function orchestrateChat(request) {
    const metros = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_metros");
    const years = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$ai$2f$tool$2d$runner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runTool"])("get_available_years");
    const context = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f3b01f9._.js.map